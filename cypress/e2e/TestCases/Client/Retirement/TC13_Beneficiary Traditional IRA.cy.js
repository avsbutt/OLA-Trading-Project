...
describe('Client - Retirement - Beneficiary Traditional IRA', () => {
  ...
  it('Verify that US Citizen User can Create Beneficiary Traditional IRA Account || ID Type #Driver License', () => {

    
    TC_CreateNewAccountPage.CreateRetirementAccount_TypeBeneficiaryTraditionalIRA();
    CloseToasterIfAppearUtils();
  ...
  it('Verify that US Citizen User can Create Beneficiary Traditional IRA Account || ID Type #Passport', () => {
  ...
  it('Verify that US Citizen User can Create Beneficiary Traditional IRA Account || ID Type #Govt ID', () => {
  ...
  it('Verify that Foreign User cannot Open Beneficiary Traditional IRA Account' , ()=>{
