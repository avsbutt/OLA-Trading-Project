...
describe('Client - Retirement - SEP IRA', () => {
  ...
  it('Verify that US Citizen User can Create SEP IRA Account || ID Type #Driver License', () => {

    
    TC_CreateNewAccountPage.CreateRetirementAccount_TypeSEPIRA();
    CloseToasterIfAppearUtils();
  ...
  it('Verify that US Citizen User can Create SEP IRA Account || ID Type #Passport', () => {
  ...
  it('Verify that US Citizen User can Create SEP IRA Account || ID Type #Govt ID', () => {
  ...
  it('Verify that Foreign User cannot Open SEP IRA Account' , ()=>{
